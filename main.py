...
def main(args):
    ...
    train_dataset, relation_labels, num_labels, id2label, label2id, train_size = load_and_cache_examples(args,
                                                                                                         tokenizer,
                                                                                                         mode="train")
    dev_dataset, relation_labels, num_labels, id2label, label2id, dev_size = load_and_cache_examples(args, tokenizer,
                                                                                                     mode="dev")
    test_dataset, relation_labels, num_labels, id2label, label2id, test_size = load_and_cache_examples(args, tokenizer,
                                                                                                       mode="test")
    ...
    # agnews的类别比例[(1, 1072), (2, 1019), (0, 935), (5, 763), (4, 718), (3, 78)]
    ...
    trainer = Trainer(args, train_dataset=train_dataset, dev_dataset=dev_dataset, test_dataset=test_dataset,
                      ...
                      # \ masked_test_dataset = masked_test_dataset, masked_unlabeled_dataset =
                      # masked_unlabeled_dataset, \
    ...
    if args.do_train:
        ...
        if args.method in ['clean', 'noisy', "noise"]:
            ...
            trainer.train()
            trainer.self_train(soft=args.soft_label)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sampling_rate', type=float, default=0.5, help='sampling rate for rebalancing dataset')
